...
void ProjectManagerLayer::save_projects()
{
    ...
    try
    {
        ...
        AERO_CORE_INFO("Successfully saved {0} projects to: {1}", m_projects.size(),
...
void ProjectManagerLayer::on_imgui_render()
{
    ...
    ImGui::InputTextWithHint("##SearchProjects", "Search Projects...", search_buffer,
    ...
    for (int i = 0; i < m_projects.size(); i++)
    {
        ...
        bool selected = false;
        if (ImGui::Selectable("##ProjectItem", &selected, ImGuiSelectableFlags_AllowDoubleClick,
                              item_size))
        {
...
void ProjectManagerLayer::open_project(const std::string path)
{
    ...
    AERO_CORE_INFO("Opening Project:{0}, Project FilePath:{1}", project->get_name(),
