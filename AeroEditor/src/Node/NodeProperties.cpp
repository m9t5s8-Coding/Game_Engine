...
void Texture_Component::imgui_render(Entity entity)
{
  NodeProperties::draw_component_node<Texture_Component>(
      "Texture Component",
      entity,
      [entity](Texture_Component& props) { UI::draw_texture(entity); },
      false);
}
...
void Script_Component::imgui_render(Entity entity)
{
  NodeProperties::draw_component_node<Script_Component>(
      "Scirpt Component",
      entity,
      [entity](Script_Component& props) mutable { UI::draw_script_selector(entity); },
      true);
}
...
void Window_Component::imgui_render(Entity entity)
{
  NodeProperties::draw_component_node<Window_Component>(
      "Window Component",
      entity,
      [](Window_Component& props) { UI::draw_vec2("Size", props.size, {1280, 720}); },
      true);
}
      ...
      [](CameraFollow_Component& props)
      {
        ...
        switch (props.type)
        {
          ...
          case FollowType::SPRING:
          {
            ...
            ImGui::PushItemWidth(-1);
            ImGui::DragFloat("##SpringDamping",
                             &props.spring_damping,
                             0.5f,
                             0.1f,
                             100.0f,
                             "Damping: %.1f");
...
void Animation_Component::imgui_render(Entity entity)
{
  NodeProperties::draw_component_node<Animation_Component>(
      "Animation Component",
      entity,
      [entity](Animation_Component& anim) { UI::draw_animation(entity); },
      false);
}
...
void SolidSet_Component::imgui_render(Entity entity)
{
  NodeProperties::draw_component_node<SolidSet_Component>(
      "SolidSet Component",
      entity,
      [entity](SolidSet_Component& tile) { ImGui::Text("%d", tile.placed_tiles.size()); },
      true);
}
...
void TileSet_Component::imgui_render(Entity entity)
{
  NodeProperties::draw_component_node<TileSet_Component>(
      "TileSet Component",
      entity,
      [entity](TileSet_Component& tile) { UI::draw_tilemap_register(entity); },
      true);
}
...
void CollisionShape_Component::imgui_render(Entity entity)
{
  NodeProperties::draw_component_node<CollisionShape_Component>(
      ...
      [](CollisionShape_Component& props)
      {
        ...
        ImGui::InputTextWithHint("##NewShapeName",
                                 "Create New Shape",
                                 new_shape_name,
        ...
        if (ImGui::BeginPopupModal("ShapeName Exists", nullptr, ImGuiWindowFlags_AlwaysAutoResize))
        {
...
void AutoTiling_Component::imgui_render(Entity entity)
{
  NodeProperties::draw_component_node<AutoTiling_Component>(
      "AutoTiling Component",
      entity,
      [entity](AutoTiling_Component& comp) mutable { UI::draw_autotiling_register(entity); },
      true);
}
...
void Audio_Component::imgui_render(Entity entity)
{
  NodeProperties::draw_component_node<Audio_Component>(
      ...
      [entity](Audio_Component& comps) mutable
      {
        ...
        {
          auto full_path =
              FileDialogs::open_file("Audio Files\0*.mp3;*.wav;*.ogg;*.flac\0All Files\0*.*\0");
          if (!full_path.empty())
          {
