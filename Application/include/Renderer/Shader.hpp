...
public:
  ...
  virtual void set_float_rect(const std::string& name, const float_rect& rect) const    = 0;
  ...
  static std::shared_ptr<Shader> create(const std::string& p_name,
...
public:
  ...
  std::shared_ptr<Shader> load(const std::string& p_name,
                               const std::string& p_vertex_path,
                               const std::string& p_fragment_path);
