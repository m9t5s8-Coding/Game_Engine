...
public:
  ...
  {
    m_view.set_center(center);
  }

  void set_viewport_mouse(const vec2f& mouse_pos)
  {
    m_mouse_in_viewport = mouse_pos;
  }
  void set_viewport_size(const vec2f& viewport_size)
  {
  ...
  static void set_main_controller(const AG_ref<ViewController>& controller)
  {
    s_main_controller = controller;
  }
  static AG_ref<ViewController> get_main_controller()
  {
    return s_main_controller;
  }

  static float_rect get_view_floatrect()
  {
    return s_main_controller->get_view().get_float_rect();
  }
