...
namespace ag::UI
{
    ...
    // Helper functions
    inline void BeginProperty(const char* label, const char* tooltip = nullptr, bool same_line = true) {
    ...
    inline bool DrawResetButton(const char* label, const ImVec4& color) {
    ...
    // Additional useful property widgets
