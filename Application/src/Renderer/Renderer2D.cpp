...
namespace ag
{
	...
	void Renderer2D::init()
	{
		...
		}
		{
			...
			s_data->quad_texture = ag::Texture2D::create("assets/textures/default.png", true, Filter_Mode::AG_NEAREST);
			s_data->text_texture = ag::Texture2D::create("assets/textures/atlas.png", true, Filter_Mode::AG_LINEAR);
	...
	void Renderer2D::draw_text(const Text& text_string, const Transform_Component& transform, int entity_id)
	{
		...
		Transform_Component trans;
		trans.position = transform.position - (longest_size * 0.5);
