...
std::shared_ptr<Shader> Shader::create(const std::string& p_shader_path)
{
  switch (Renderer::get_API())
  {
    ...
    case RendererAPI::API::OpenGL:
      ...
      return std::make_shared<OpenGLShader>(p_shader_path);
#else
      return nullptr;
#endif
    case RendererAPI::API::OpenGL_ES:
#ifdef PLATFORM_ANDROID
      return AG_cref<OpenGL_ESShader>(p_shader_path);
#else
      return nullptr;
#endif
...
std::shared_ptr<Shader> Shader::create(const std::string& p_name, const std::string& p_shader_path)
{
  switch (Renderer::get_API())
  {
    ...
    case RendererAPI::API::OpenGL:
#if defined(PLATFORM_LINUX) || defined(PLATFORM_WINDOWS)
      return std::make_shared<OpenGLShader>(p_name, p_shader_path);
#else
      return nullptr;
#endif
    case RendererAPI::API::OpenGL_ES:
#ifdef PLATFORM_ANDROID
      return AG_cref<OpenGL_ESShader>(p_name, p_shader_path);
#else
      return nullptr;
#endif
    case RendererAPI::API::Metal:
...
std::shared_ptr<Shader> Shader::create(const std::string& p_name,
                                       ...
                                       const std::string& p_fragment_path)
{
  switch (Renderer::get_API())
  {
    ...
    case RendererAPI::API::OpenGL:
      ...
      return std::make_shared<OpenGLShader>(p_name, p_vertex_path, p_fragment_path);
#else
      return nullptr;
#endif
    case RendererAPI::API::OpenGL_ES:
#ifdef PLATFORM_ANDROID
      return AG_cref<OpenGL_ESShader>(p_name, p_vertex_path, p_fragment_path);
#else
      return nullptr;
#endif
    case RendererAPI::API::Metal:
...
std::shared_ptr<Shader> ShaderLibrary::load(const std::string& p_name,
