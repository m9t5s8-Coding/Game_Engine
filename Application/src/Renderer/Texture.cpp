...
namespace ag
{
  std::shared_ptr<Texture2D> Texture2D::create(const std::string& p_path, bool reload, Filter_Mode filter_mode)
  {
    ...
    switch (Renderer::get_API())
    {
      ...
      case RendererAPI::API::OpenGL:
      {
        ...
        auto texture = std::make_shared<OpenGLTexture2D>(p_path, filter_mode);
