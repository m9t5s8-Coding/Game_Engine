...
void ImGuiLayer::on_attach()
{
    ...
    ImFont* main_font =
        io.Fonts->AddFontFromFileTTF("assets/fonts/OpenSans-Regular.ttf", 20.0f, &font_cfg);
    ...
    io.Fonts->AddFontFromFileTTF("assets/fonts/fa-solid-900.ttf", 16.0f, &icon_cfg, icon_ranges);

    ImFont* large_font =
        io.Fonts->AddFontFromFileTTF("assets/fonts/OpenSans-Regular.ttf", 28.0f, &font_cfg);
