...
Node_Capability get_node_capabilities(NodeType type)
{
  switch (type)
  {
    ...
    case ag::NodeType::Rectangle:
      return Node_Capability::RectShape | Node_Capability::Render2D | Node_Capability::Physics2D |
             Node_Capability::Transform | Node_Capability::UI;

    case ag::NodeType::Circle:
      return Node_Capability::CircleShape | Node_Capability::Render2D | Node_Capability::Physics2D |
             Node_Capability::Transform | Node_Capability::UI;

    case ag::NodeType::Sprite:
      return Node_Capability::Render2D | Node_Capability::Physics2D | Node_Capability::Texture2D |
             Node_Capability::Transform | Node_Capability::UI;
    ...
    case ag::NodeType::Text:
      return Node_Capability::Text | Node_Capability::Transform | Node_Capability::UI;
